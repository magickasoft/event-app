      ...
      <ScrollView
        ...
        <Box
          ...
          <VStack space="md">
            ...
            <Text fontSize="$sm">
              Your new password must be different from previous used passwords and must be of at least 8 characters.
            </Text>
          </VStack>
          <VStack
            mt="$7"
          ...
          <Button variant="solid" size="lg" mt="auto" sx={{'@md': {mt: '$40'}}} onPress={handleSubmit(onSubmit)}>
